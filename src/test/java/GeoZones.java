...
public class GeoZones {
    ...
    public void geoZones() {
        ...
        driver.findElement(By.cssSelector("#sidebar li a[href *= 'geo_zones']")).click();
        wait.until(textToBe(By.cssSelector("h1"), "Geo Zones"));
        ...
        for (WebElement country : countriesList) {
            countriesID.add(country.findElement(By.cssSelector("td:nth-child(2)")).getText());
        }
        ...
        for (String id : countriesID) {
            ...
            assertTrue(zonesCopy.equals(zones), "Zones are not sorted for country id " + id + ".");
